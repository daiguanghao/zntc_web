 ...
 * ，容易出现内存溢出,用户模式读取Excel的典型代码如下： FileInputStream file=new FileInputStream("c:\\test.xlsx");
...
public class XLSXCovertCSVReader
{
     ...
     */
    public XLSXCovertCSVReader(OPCPackage pkg, String sheetName, int minColumns)
    {
    ...
    public
        List<String[]>
        processSheet(StylesTable styles, ReadOnlySharedStringsTable strings,
    ...
    public
        List<String[]>
        process() throws IOException, OpenXML4JException, ParserConfigurationException, SAXException
    {
    ...
    public static
        List<String[]>
        readerExcel(InputStream inputStream, String sheetName, int minColumns) throws IOException, OpenXML4JException, ParserConfigurationException, SAXException
    {
        // OPCPackage p = OPCPackage.open(path, PackageAccess.READ);
        OPCPackage p = OPCPackage.open(inputStream);
        XLSXCovertCSVReader xlsx2csv = new XLSXCovertCSVReader(p, sheetName, minColumns);
    ...
    {
        // List<String[]> list = XLSXCovertCSVReader.readerExcel("D:/50万.xlsx",
        // "Sheet1", 2);
